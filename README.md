...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-2apfkro.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-2apfkro.containers.anotherwebservice.com/
...
```
git clone git@github.com:xerinv0/container-2apfkro.git
cd container-2apfkro
```
...
```
docker attach container-2apfkro
```
